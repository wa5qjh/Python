...
""" Modules to  be imported for some or most projects
    intended to be changed for the requirements or needs of
     individual enviornment such as BSD's ,Linux, Winodws  etc.
"""
...
#    ====== test and documentation section  only ===========

if __name__ == "__main__":
    print( """Auth: Gary B. Corell
Tkinter function added by Dale E. Moore
